...
#
# Script generated by Vivado on Wed Sep 10 10:31:56 +0530 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : audio_bram.sh
...
#
# Usage        : audio_bram.sh
#                audio_bram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                audio_bram.sh [-reset_run]
#                audio_bram.sh [-reset_log]
#                audio_bram.sh [-help]
#
...
# script info
echo -e "audio_bram.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./audio_bram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot audio_bram xil_defaultlib.audio_bram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim audio_bram -key {Behavioral:sim_1:Functional:audio_bram} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb audio_bram.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./audio_bram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: audio_bram.sh [-help]\n\
Usage: audio_bram.sh [-step]\n\
Usage: audio_bram.sh [-lib_map_path]\n\
Usage: audio_bram.sh [-reset_run]\n\
Usage: audio_bram.sh [-reset_log]\n\
Usage: audio_bram.sh [-keep_index]\n\
Usage: audio_bram.sh [-noclean_files]\n\n\
